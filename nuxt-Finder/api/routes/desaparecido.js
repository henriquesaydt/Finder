...
router.post('/', authorization, async (req, res) => {
  ...
  if (newDesaparecido.is_animal && newDesaparecido.eventoId && ((newDesaparecido.pessoa_id && !newDesaparecido.animal_id) || (!newDesaparecido.pessoa_id && newDesaparecido.animal_id))) {
    try {
